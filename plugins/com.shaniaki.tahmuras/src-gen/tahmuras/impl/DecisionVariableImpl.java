 ...
 * @generated
 */
public class DecisionVariableImpl extends MinimalEObjectImpl.Container implements DecisionVariable {
	/**
	...
	protected EClass eStaticClass() {
		return TahmurasPackage.Literals.DECISION_VARIABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TahmurasPackage.DECISION_VARIABLE__NAME, oldName, name));
	}
	...
	public void setDomain(String newDomain) {
		...
		domain = newDomain;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TahmurasPackage.DECISION_VARIABLE__DOMAIN, oldDomain, domain));
	}
	...
	public void setSize(int newSize) {
		...
		size = newSize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TahmurasPackage.DECISION_VARIABLE__SIZE, oldSize, size));
	}
